...
void TrafficLight::cycleThroughPhases()
{
    ...
    std::chrono::time_point<std::chrono::system_clock> lastUpdate; //instantiate stopwatch variable
    
  	srand (time(NULL)); /* initialize random seed: */
  	double cycleDuration = rand() % 2000 + 4000; // duration of a single simulation cycle [4, 6] seconds
    ...
    while (true)
    {
        // sleep at every iteration to reduce CPU usage, 1ms
